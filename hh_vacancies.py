...
class HH_api_get(APIget):
    ...
    def save_vacancies_to_file(self):
        # Запись полученного запросив .json
...
class VacanciesHH:
    ...
    def sorted_vacancies(self):
        # Чтение и сортировка файла .json
    ...
    def salary_int(self):
        ...
        self.non_zero_salary_jobs = [i for i in self.sorted_city_name if
                                     i.get('Зарплата') and i['Зарплата'] != 'не указано']
    ...
    def sorted_by_salary_range(self, salary_from, salary_to):
        # Сортировка зарплаты от __, до __
        sorted_salary_range = [
